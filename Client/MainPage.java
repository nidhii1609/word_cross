...
public class MainPage {
    ...
    public Button watch = new Button();
    ...
    public void step2(){
        ...
        watch.setText("Watch");
        watch.setFont(Font.font("Times",FontWeight.NORMAL,16));
        ...
        /**
         *
         * The action after clicking button Watch
         */

        watch.addEventFilter(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
            @Override
